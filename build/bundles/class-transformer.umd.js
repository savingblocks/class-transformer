    ...
    var TransformOperationExecutor = /** @class */ (function () {
        ...
        TransformOperationExecutor.prototype.transform = function (source, value, targetType, arrayType, isMap, level) {
            ...
            if (Array.isArray(value) || value instanceof Set) {
                ...
                var targetClass = (targetType === null || targetType === void 0 ? void 0 : targetType.target) || targetType;
                // further resolve any @Type() decorator on the target type
                if (targetType) {
                    var metadata = defaultMetadataStorage.findTypeMetadata(targetClass, undefined);
                    if (metadata && typeof metadata.typeFunction === 'function') {
                        var options = { newObject: undefined, object: value, property: undefined };
                ...
                if (this.transformationType === exports.TransformationType.PLAIN_TO_CLASS ||
                    ...
                    if (!source) {
                        ...
                        var valueProto = Object.getPrototypeOf(newValue);
