...
class TransformOperationExecutor {
    ...
    transform(source, value, targetType, arrayType, isMap, level = 0) {
        if (Array.isArray(value) || value instanceof Set) {
            ...
            let targetClass = (targetType === null || targetType === void 0 ? void 0 : targetType.target) || targetType;
            // further resolve any @Type() decorator on the target type
            if (targetType) {
                const metadata = storage_1.defaultMetadataStorage.findTypeMetadata(targetClass, undefined);
                if (metadata && typeof metadata.typeFunction === 'function') {
                    const options = { newObject: undefined, object: value, property: undefined };
